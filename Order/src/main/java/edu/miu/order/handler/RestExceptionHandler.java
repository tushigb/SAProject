package edu.miu.order.handler;

import edu.miu.order.constant.ExceptionType;
import edu.miu.order.dto.response.ErrorResponse;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleBusinessException(BusinessException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(HttpStatus.BAD_REQUEST, "business", ex.getMessage(), ex.reasons));
    }
